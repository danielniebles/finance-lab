...
export function FloatingChat() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed bottom-44 right-6 z-50 w-80 rounded-2xl border border-border bg-card shadow-2xl flex flex-col transition-all duration-200 origin-bottom-right md:bottom-20",
      ...
      <Button
        size="icon"
        className="fixed bottom-30 right-6 z-50 size-12 rounded-full shadow-lg md:bottom-6"
